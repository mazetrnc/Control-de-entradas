...
#
# Uso:
#   1. Coloca este archivo junto a entradas_pae26.py y reporte_quincenal.py
...
# reporte_quincenal.py se detecta solo (es un import local normal), pero se
# deja explícito aquí como respaldo por si PyInstaller no lo detectara.
hiddenimports += ['reporte_quincenal']
